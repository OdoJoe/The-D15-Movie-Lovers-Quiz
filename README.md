...
- ### <u>Testing</u>
* HTML validation 
 ![HTML validation screenshot - no errors](documentation/wireframes/HTMLValidator.png)
* CSS validation
![CSS validation screenshot - no errors](documentation/wireframes/CSSValidation.png)
* JavaScript validation - noted warning regarding using esversion 6 but which does not affect execution.
![javascript validation screenshot - no errors](documentation/wireframes/jshint1.png)
![javascript validation screenshot - no errors](documentation/wireframes/jshint2.png)
